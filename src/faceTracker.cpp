...
cv::Mat faceTracker::correctGamma(const cv::Mat& image, const unsigned int& gamma ){
...
cv::Mat faceTracker::initialFramePreproc(const cv::Mat& image){
...
void faceTracker::update(cv::Mat& frame){
